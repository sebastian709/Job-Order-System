    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
               <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800" style="text-align:center; margin-left:16%; font-weight:bold;">Order Description</h1>
          <?php 
                  ...
                  <td id="ml">
                    <form method="post" action="Head-Record-JOS.php">
                        <input type="hidden" name="" value="<?php echo $row["id"];  ?>">
                           <button class="btn-primary"  style="font-weight:bold; border-radius:10px 10px 10px 10px; float: right; margin-right: 5%;"><i class="fas fa-arrow-circle-left"></i> back</button>
                       </form></td>
