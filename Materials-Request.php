...
<table style="text-transform: uppercase; width: 100%; border: 2px solid gray; color: black ">
                ...
                <tr style=" border-bottom: 2px solid gray; height: 30px;">
                  ...
                  <td id="ml"><h6 style="visibility: hidden;"><?php echo  $row["id"]; ?></td>
                  <td id="ml">
                    <button class="btn btn-warning deliveredbtn" style="font-weight:bold; border-radius:10px 10px 10px 10px; float: right; margin-right: 5%;" >Delivered</button>
                    

                    <form method="post" action="Admin-Engineer.php">
                        
                           <button class="btn btn-primary" type="submit"  style="font-weight:bold; border-radius:10px 10px 10px 10px; float: right; margin-right: 5%;"><i class="fas fa-arrow-circle-left"></i> back</button>
                       </form></td>
 ...
 <!-- Message Modal-->
  <div class="modal fade" id="MessageModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content back">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Materials Status</h5>
          <button class="close" type="button" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true"><h5 id="x">×</h5></span>
          </button>
        </div>

          <form method="POST" action="Materials-Request.php">

          <div class="modal-body">
            <input type="hidden" name="deliver_id" id="deliver_id">
            
            <h5 style="color: white; ">The materials is already delivered? Just click confirm if the materials is already delivered.</h5><br>
            <label style="color: white; font-weight: bold;">DATE:</label>
            <style type="text/css">::placeholder{color: white; text-align: left;}</style>
          <input style="background-color: transparent; border: none;  width:33%; outline: none; color: white;" type="DATE" name="petsa" placeholder="DD/MM/YYYY" required> 
  


        <div class="modal-footer">
          <button class="btn btn-secondary" id="prim" type="button" data-dismiss="modal">Cancel</button>
         <button type="submit" class="btn btn-success" name="deliver_btn">Confirm</button>
