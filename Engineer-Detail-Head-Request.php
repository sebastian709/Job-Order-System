...
<table style="text-transform: uppercase; width: 100%; border: 2px solid gray; color: black ">
                ...
                <tr style=" border-bottom: 2px solid gray; height: 30px;">
                 ...
                 <td><h6 style="visibility: hidden;"><?php echo  $row["id"]; ?></h6></td>
                  <td id="ml" ></td>
                   <td id="ml">
                     <button class="btn btn-success finishbtn" style="font-weight:bold; border-radius:10px 10px 10px 10px; float: right; margin-right: 5%;" >Finished</button>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content back">
        <div class="modal-header">
          ...
          <form method="POST" action="Engineer-Detail-Head-Request.php">

          <div class="modal-body">
            <input type="text" name="finish_id" id="finish_id">
            <h6 style="color: white;">The job is in progress?</h6><br><br>
  


        <div class="modal-footer">
          <button class="btn btn-secondary" id="prim" type="button" data-dismiss="modal">Cancel</button>
         <button type="submit" class="btn btn-success" name="finish_btn">Fullfilled</button>
